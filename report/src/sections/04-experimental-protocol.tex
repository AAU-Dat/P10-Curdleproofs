...
Getting the public key makes use of an existing function called \texttt{extractPublicKey}, which uses the attestation's data to get public key and ID of the validator.
...
the data is logged to an \texttt{SQL} database.
