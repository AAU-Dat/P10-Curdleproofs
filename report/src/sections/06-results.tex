...
\begin{figure*}[!htb]
    \centering
    \subfloat[\centering]{{\includegraphics[width=0.325\textwidth]{figures/results/4096-256-p2} }}%
    \subfloat[\centering]{{\includegraphics[width=0.325\textwidth]{figures/results/5462-256-p2} }}%
    \subfloat[\centering]{{\includegraphics[width=0.325\textwidth]{figures/results/8192-256-p2} }}%
...
\begin{figure*}[!htb]
    \centering
    \subfloat[\centering]{{\includegraphics[width=0.325\textwidth]{figures/results/violin-4096} }}%
    \subfloat[\centering]{{\includegraphics[width=0.325\textwidth]{figures/results/violin-5462} }}%
    \subfloat[\centering]{{\includegraphics[width=0.325\textwidth]{figures/results/violin-8192} }}%
