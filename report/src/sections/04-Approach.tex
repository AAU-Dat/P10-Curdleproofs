...
\begin{figure}[ht]
\begin{framed}
    \begin{lstlisting}[language=Python,mathescape=true,label={lst:schemefunc},numbers=left]
    input: $n$, where $n>0$
...
\begin{figure}[h]
\begin{framed}
    \begin{lstlisting}[language=Python,mathescape=true,label={lst:ipa-prover},numbers=left]
$\textbf{Step 1:}$
...
\begin{figure}[h]
\begin{framed}
\begin{lstlisting}[language=Python,mathescape=true,label={lst:ipa-verifier},numbers=left]
$\textbf{Step 1:}$
...
An adversarial shuffle can be seen as no shuffling being done.
...
\begin{figure}[ht]
    \begin{framed}
        \begin{lstlisting}[language=Python,mathescape=true,label={lst:ipa-verifier-optimized},numbers=left]
$\textbf{Step 1:}$
