...
The core concept of the Springproofs scheme function is to split the vectors before each recursive round of the protocol.
Then, the fold for that round is only done on one of the two sets, before the other set is appended again at the end of the recursive round.
